...
//                     <div className='mt-2 sm:mt-0 xl:mt-5'>
//                         <h2 className='font-sans font-medium text-[24px] leading-[32.11px] text-[rgba(30,40,49,1)]'>Split Air Conditioning</h2>
//                         <p className='mt-1 sm:mt-3 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] sm:max-w-[266px] xl:w-[250px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply </p>
//                         <div className='mt-2 sm:mt-0 xl:mt-15 flex items-center'>
//                             <img src={knowMore} alt="img" className='w-[103px] object-contain' />
//                             <img src={arrowUp} alt="img" className='w-[20px]' />
...
//                 </div>
//                 <div className='mt-5 sm:flex items-center xl:items-start  gap-3'>
//                     <img src={ac3} alt="img" className='w-full sm:w-[280px] md:w-[200px] xl:w-[272px] h-[303px]' />
//                     <div className='mt-2 sm:mt-0 xl:mt-5'>
//                         <h2 className='font-sans font-medium text-[24px] leading-[32.11px] text-[rgba(30,40,49,1)]'>Package Unit</h2>
//                         <p className='mt-1 sm:mt-3 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] sm:max-w-[266px] xl:w-[250px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply </p>
//                         <div className='mt-2 sm:mt-0 xl:mt-15 flex items-center'>
//                             <img src={knowMore} alt="img" className='w-[103px] object-contain' />
//                             <img src={arrowUp} alt="img" className='w-[20px]' />
...
//                 </div>
//                 <div className='mt-5 sm:flex items-center xl:items-start  gap-3'>
//                     <img src={ac4} alt="img" className='w-full sm:w-[280px] md:w-[200px] xl:w-[272px] h-[303px]' />
//                     <div className='mt-2 sm:mt-0 xl:mt-2'>
//                         <h2 className='font-sans font-medium text-[24px] leading-[32.11px] text-[rgba(30,40,49,1)]'>Ducted Split Air<span className='lg:block'>Conditioning</span></h2>
//                         <p className='mt-1 sm:mt-3 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] sm:max-w-[266px] xl:w-[250px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply </p>
//                         <div className='mt-2 sm:mt-0 xl:mt-10 flex items-center'>
//                             <img src={knowMore} alt="img" className='w-[103px] object-contain' />
//                             <img src={arrowUp} alt="img" className='w-[20px]' />
//                         </div>
//                     </div>
      ...
      <div className="md:flex justify-between gap-2 xl:gap-20">
        ...
        <div className="md:sticky md:top-0">
          ...
          <h1 className="sm:mt-1 lg:mt-2 font-sans font-medium text-[30px] leading-[30px] xl:text-[60px] xl:leading-[60px] text-[rgba(30,40,49,1)]">
            Professional<span className="block">Services Tailored</span>
            <span className="block">for You</span>
          </h1>
          <p className="mt-2 sm:mt-3 md:mt-5 lg:mt-8 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] max-w-[543px]">
          ...
          <div className="mt-6 sm:mt-2">
            ...
            <div className="sm:flex items-center xl:items-start gap-3">
              ...
              <div className="mt-2 sm:mt-0 xl:mt-5">
                ...
                <p className="mt-1 sm:mt-3 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] sm:max-w-[266px] xl:w-[250px]">
            ...
            <div className="mt-5 sm:flex items-center xl:items-start gap-3">
              ...
              <div className="mt-2 sm:mt-0 xl:mt-2">
                <h2 className="font-sans font-medium text-[24px] leading-[32.11px] text-[rgba(30,40,49,1)]">
                  Ducted Split Air<span className="lg:block">Conditioning</span>
                </h2>
                <p className="mt-1 sm:mt-3 text-[rgba(84,84,113,1)] font-sans font-light text-[16px] sm:text-[18px] leading-[26.6px] sm:leading-[30.6px] sm:max-w-[266px] xl:w-[250px]">
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                </p>
