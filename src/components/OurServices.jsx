    ...
    <div className="px-3 sm:px-8 mt-6 md:mt-20 lg:mt-25">
      <div className="md:flex justify-between gap-2 xl:gap-20">
        ...
        <div className="md:sticky md:top-0">
          <h4 className="text-[rgba(57,125,168,1)] font-sans font-medium text-[20px] leading-[34px]">
            OUR SERVICES
          </h4>
          ...
          <div className="mt-2 sm:mt-3 md:mt-5 lg:mt-8 flex items-center gap-3">
            <img
              src={button4}
              alt="img"
              className="w-[180px] lg:w-[238px] xl:w-[338px]"
            />
            <img
              src={button5}
              alt="img"
              className="w-[100px] lg:w-[138px] xl:w-[189px]"
            />
          </div>
        </div>
          ...
          <div className="mt-6 sm:mt-2">
            ...
            <div className="sm:flex items-center xl:items-start gap-3">
              <img
                src={ac1}
                alt="img"
                className="w-full sm:w-[280px] md:w-[200px] xl:w-[272px] h-[303px]"
              />
            ...
            <div className="mt-5 sm:flex items-center xl:items-start gap-3">
              <img
                src={ac2}
                alt="img"
                className="w-full sm:w-[280px] md:w-[200px] xl:w-[272px] h-[303px] rounded-[10px]"
              />
              <div className="mt-2 sm:mt-0 xl:mt-5">
                <h2 className="font-sans font-medium text-[24px] leading-[32.11px] text-[rgba(30,40,49,1)]">
