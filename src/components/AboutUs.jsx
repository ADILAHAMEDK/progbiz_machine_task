  ...
  return (
    <div className='mt-8'>
      <div className='px-3 sm:px-8'>
        <h3 className='text-[rgba(57,125,168,1)] font-sans font-medium text-[20px] leading-[27.2px]'>ABOUT US</h3>
        <div className='md:flex justify-between gap-10'>
          ...
          <p className='w-full max-w-[820px] font-sans font-light text-[18px] leading-[28px] md:text-[24px] md:leading-[45px] text-[rgba(84,84,113,1)]'>
            Founded in the Emirate of Abu Dhabi in 2012,<span className='xl:block'>Cool Technologies have emerged to be one of the leading</span>
            suppliers of industrial cooling equipment in the UAE for the past<span className='xl:block'>10 years.</span>
          </p>
        </div>
